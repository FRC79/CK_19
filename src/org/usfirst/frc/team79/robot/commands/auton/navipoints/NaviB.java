...
public class NaviB extends CommandGroup {
	
	public NaviB(CommandGroup obstacle) {
		addSequential(obstacle); // navigate the obstacle
		addSequential(new RotateToDegree(0)); // realign the bot at zero
